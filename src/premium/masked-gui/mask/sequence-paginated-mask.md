...
This is the same as the [Button Paginated Mask](./button-paginated-mask.md). The only difference is that this mask assumes each button as a page, so it will "shift" the buttons to the left or right depending on the page.
...
![Sequence Paginated 1](./images/sequence-paginated-1.gif)
